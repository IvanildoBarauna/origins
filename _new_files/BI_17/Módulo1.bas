...
Sub BtOnActionCall_08(control As IRibbonControl)
    ...
    OpenUrl ("http://planilheiros.com.br/videoaulas/Index.html")

End Sub

Sub BtOnActionCall_09(control As IRibbonControl)

    OpenUrl ("http://planilheiros.com.br/Presencial/Dashboards.htm")

End Sub

Sub BtOnActionCall_10(control As IRibbonControl)

    OpenUrl ("http://planilheiros.com.br/Presencial/Self-Service%20BI.htm")
