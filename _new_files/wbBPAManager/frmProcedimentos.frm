...
Attribute VB_Base = "0{E4CA061B-8C32-40B0-9CB1-33B3AFCAB988}{BB971886-9284-4999-B41E-4C397C5BDEBF}"
...
Private Sub UserForm_Initialize()
    ...
    With Me
        .txt_databpa.Value = VBA.DateSerial(Year(Date), Month(Date) - 1, 21)
