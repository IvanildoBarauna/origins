...
'Exemplo: Se um valor foi recebido como texto e precisa ser inserido como número, fazemos esta operação na tentativa de limpar o formato atual'
   ...
   Call ClassificarA_Z
    ...
    'COMPARAÇÃO DE REGISTROS NO REPORT DO MARCOS'
    
    Application.StatusBar = "Comparando casos com relatório externo ... "
    
ChDir ("\\Br238p-hpq0064\Equipe\Ivan Jr - FUPO\Relatórios\Marcos Batista")
Workbooks.Open Filename:="\\Br238p-hpq0064\Equipe\Ivan Jr - FUPO\Relatórios\Marcos Batista\Callback SLA.xlsx"

Windows("Callback SLA.xlsx").Activate


ActiveSheet.Range("$B$2:$Z$1277").AutoFilter Field:=21, Criteria1:= _
        "Jefte Soares Da Silva"
        
        'COPIA E COLA A COLUNA DOS CASOS'
        
    Range("O2").Select
    Range(Selection, Selection.End(xlDown)).Copy
    
    Windows("BASE_CASOS").Activate
    Plan6.Range("A1").PasteSpecial xlPasteValuesAndNumberFormats
    
        
         'COPIA E COLA A COLUNA DOS CBS'
    ...
    Windows("BASE_CASOS").Activate
    Plan6.Range("B1").PasteSpecial xlPasteValuesAndNumberFormats
    
    'COPIA E COLA A COLUNA DAS DATAS'
    ...
    Windows("BASE_CASOS").Activate
    Plan6.Range("C1").PasteSpecial xlPasteValuesAndNumberFormats
    
      'COPIA E COLA A COLUNA DOS HORÁRIOS'
    ...
    Windows("BASE_CASOS").Activate
    Plan6.Range("F1").PasteSpecial xlPasteValuesAndNumberFormats
    
    'COPIA E COLA A COLUNA DOS AGENTES'
    ...
    Windows("BASE_CASOS").Activate
    Plan6.Range("G1").PasteSpecial xlPasteValuesAndNumberFormats
    ...
    Application.StatusBar = "Fechando relatório externo ... "
